...
var src_default = {
  async fetch(request, env) {
    ...
    try {
      ...
      const url = `https://www.googleapis.com/calendar/v3/calendars/${calendar}/events?key=${apiKey}&timeMin=${(/* @__PURE__ */ new Date()).toISOString()}&singleEvents=true&orderBy=startTime`;
...
// .wrangler/tmp/bundle-Yc4QA5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Yc4QA5/middleware-loader.entry.ts
