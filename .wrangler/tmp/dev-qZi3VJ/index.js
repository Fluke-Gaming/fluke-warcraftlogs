...
var src_default = {
  async fetch(request, env) {
    ...
    try {
      ...
      const url = `https://www.googleapis.com/calendar/v3/calendars/${CALENDAR_ID}/events?key=${apiKey}&timeMin=${(/* @__PURE__ */ new Date()).toISOString()}&singleEvents=true&orderBy=startTime`;
...
// .wrangler/tmp/bundle-9kPhS2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-9kPhS2/middleware-loader.entry.ts
